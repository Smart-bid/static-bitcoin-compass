                                ...
                                <g id="chart">
                                    <g className="cls-2">
                                        <g id="chart-group">
                                            ...
                                            <g stroke-linejoin="round" id="chart-line" className="cls-4">
                                                <path vector-effect="non-scaling-stroke" fill="none" stroke="#337ab7"
                                                      stroke-width="2" d="M-300-294"></path>
                                                <path vector-effect="non-scaling-stroke" fill="none" stroke="#3aaa35"
                                                ...
                                                <path vector-effect="non-scaling-stroke" fill="none" stroke="#337ab7"
                                                      stroke-width="1.1" d="M-190-39"></path>
                                            </g>
                                        </g>
                                    </g>
                                </g>
